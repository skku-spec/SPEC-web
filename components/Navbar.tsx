      ...
      <nav>
          ...
          <div className="flex w-[320px] items-center gap-10">
            ...
            <div className="nav-item relative">
              ...
              <div className="dropdown-menu hidden">
                <div className={`dropdown-container ${dropdownBg} backdrop-blur-sm rounded-lg p-2 mt-2 border`}>
                  <Link href="/ideathon" className={`dropdown-item block px-4 py-2 ${dropdownText} rounded text-sm font-['Pretendard',sans-serif]`}>
                    아이디어톤
                  </Link>
                  <Link href="/hackathon" className={`dropdown-item block px-4 py-2 ${dropdownText} rounded text-sm font-['Pretendard',sans-serif]`}>
                    해커톤
                  </Link>
                  <Link href="/demoday" className={`dropdown-item block px-4 py-2 ${dropdownText} rounded text-sm font-['Pretendard',sans-serif]`}>
                    데모데이
                  </Link>
                </div>
              </div>
