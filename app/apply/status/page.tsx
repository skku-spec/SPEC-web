        ...
        {linkedApplication ? (
          <>
            ...
            <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              ...
              <Link
                href="/apply/edit"
                className="inline-flex h-[44px] items-center rounded-full border border-[#FF6C0F] bg-[#FF6C0F] px-6 font-['Pretendard',sans-serif] text-[14px] font-semibold text-white transition-colors hover:bg-[#e55d0b]"
              >
                지원서 수정하기
              </Link>
            </div>
            ...
            {lookupError && (
              <div className="mt-8 rounded-lg border border-[#f5c2c2] bg-[#FEE2E2] px-5 py-4">
                <p className="font-['Pretendard',sans-serif] text-sm text-[#b42318]">
                  자동 조회 중 오류가 발생했습니다. 아래 폼에서 직접 조회해주세요.
                </p>
              </div>
            )}
            <StatusCheckForm />
